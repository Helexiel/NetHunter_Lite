...
printf "\n${blue}[*] Configurando NetHunter para o Termux ...\n"
fix_profile_bash
fix_sudo
create_kex_launcher
fix_uid
...
printf "${green}[+] Para iniciar o NetHunter, digite:${reset}\n"
printf "${green}[+] nethunter             # Para iniciar o NetHunter cli${reset}\n"
printf "${green}[+] nethunter kex passwd  # Para definir a senha do KeX${reset}\n"
printf "${green}[+] nethunter kex &       # Para iniciar o NetHunter gui${reset}\n"
printf "${green}[+] nethunter kex stop    # Para parar o NetHunter gui${reset}\n"
printf "${green}[+] nethunter -r          # Para executar o NetHunter como root${reset}\n"
printf "${green}[+] nh                    # Atalho para o NetHunter${reset}\n\n"
